              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _SectionTitle(
                      title: isTh ? 'ศูนย์ควบคุมและเมนูทั้งหมด' : 'Fleet Control Center',
                      badge: isTh ? '9 ฟังก์ชันครบวงจร' : '9 Modules',
                    ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Stack(
        ...
        children: [
          Icon(Icons.radar_rounded, color: Colors.white70, size: 26),
...
class _DriverCockpitIconBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Center(
        child: Icon(Icons.speed_rounded, color: Colors.white, size: 22),
      ),
    );
  }
}
...
class _MaintenanceWrenchIconBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Center(
        child: Icon(Icons.build_circle_rounded, color: Colors.white, size: 22),
      ),
    );
  }
}
...
class _SmartExpenseIconBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Center(
        child: Icon(Icons.local_gas_station_rounded, color: Colors.white, size: 22),
      ),
    );
  }
}
...
class _AnalyticsChartIconBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Center(
        child: Icon(Icons.insights_rounded, color: Colors.white, size: 22),
      ),
    );
  }
}
...
class _CompanyEnterpriseBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Center(
        child: Icon(Icons.apartment_rounded, color: Colors.white, size: 22),
      ),
    );
  }
}
